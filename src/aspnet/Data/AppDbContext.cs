...
public class AppDbContext : DbContext
{
    ...
    private static void SeedCategorias(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Subcategoria>().HasData(
            ...
            new Subcategoria { Id = Guid.Parse("20000000-0000-0000-0000-000000000006"), CategoriaId = Guid.Parse("10000000-0000-0000-0000-000000000003"), Nome = "Mercado / Feira / Açougue" },
